...
### AUTHZ-05
Administrator cannot use IT Staff operations when the approved
authorization matrix does not grant those permissions.
...
### AUTHZ-10
Unauthorized requests do not leak whether another user's protected
resource exists.
...
### QUEUE-06
Ownership filter supports assigned/unassigned.
...
### QUEUE-14
Large page sizes above the maximum are rejected or safely constrained
...
### DETAIL-08
IT Staff can perform a permitted status transition.
...
### COMMENT-06
Over-length Public Comment is rejected.
...
### COMMENT-15
Over-length Internal Note is rejected.
...
### ADMIN-18
Administrator cannot deactivate the last active Administrator.
...
### REG-11
Development Requester selector is no longer required.
...
- Administrator communication review renders Public Comments and Internal
  Notes read-only and exposes no Ticket mutation controls
...
7. Deactivate a User.
8. Set a new initial password.
9. Login as that User.
10. Verify mandatory password change.
11. Verify Administrator cannot deactivate themselves.
12. Verify last active Administrator cannot be deactivated.
...
| AC-03 | AUTH-04 |
| AC-04 | AUTH-05, AUTH-07, E2E authentication |
| AC-05 | AUTH-10 |
| AC-06 | AUTH-11 |
...
| AC-09 | QUEUE-01 |
| AC-10 | ADMIN-01 |
| AC-11 | AUTHZ-02, AUTHZ-03, AUTHZ-04, AUTHZ-14 |
| AC-12 | REG-02, REG-03 |
...
| Migration identity preservation | REG-09, REG-10, REG-10a |
...
| AC-35 | Login.test.tsx, role-navigation checks |
